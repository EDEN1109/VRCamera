...
namespace m111001001.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        private void OnEnable ()
        {
            ...
            m_InteractiveItem.OnReticleEnter.AddListener(HandleOver);
            m_InteractiveItem.OnReticleExit.AddListener(HandleOut);
        }
        ...
        private void OnDisable ()
        {
            ...
            m_InteractiveItem.OnReticleEnter.RemoveListener(HandleOver);
            m_InteractiveItem.OnReticleExit.RemoveListener(HandleOut);
        }
